...
const StageSchema = CollectionSchema(
  ...
  embeddedSchemas: {r'StageLocation': StageLocationSchema},
  getId: _stageGetId,
...
int _stageEstimateSize(
  ...
  {
    final offsets = allOffsets[StageLocation]!;
    for (var i = 0; i < object.locations.length; i++) {
      final value = object.locations[i];
      bytesCount +=
          StageLocationSchema.estimateSize(value, offsets, allOffsets);
    }
  }
...
void _stageSerialize(
  ...
  writer.writeObjectList<StageLocation>(
    offsets[2],
    allOffsets,
    StageLocationSchema.serialize,
    object.locations,
  );
...
Stage _stageDeserialize(
  ...
  object.id = id;
  object.locations = reader.readObjectList<StageLocation>(
        offsets[2],
        StageLocationSchema.deserialize,
        allOffsets,
        StageLocation(),
      ) ??
      [];
...
P _stageDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (reader.readObjectList<StageLocation>(
            offset,
            StageLocationSchema.deserialize,
            allOffsets,
            StageLocation(),
...
extension StageQueryFilter on QueryBuilder<Stage, Stage, QFilterCondition> {
  ...
  QueryBuilder<Stage, Stage, QAfterFilterCondition> locationsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Stage, Stage, QAfterFilterCondition> locationsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'locations',
        0,
  ...
  QueryBuilder<Stage, Stage, QAfterFilterCondition> locationsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'locations',
        0,
  ...
  QueryBuilder<Stage, Stage, QAfterFilterCondition> locationsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Stage, Stage, QAfterFilterCondition> locationsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Stage, Stage, QAfterFilterCondition> locationsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension StageQueryObject on QueryBuilder<Stage, Stage, QFilterCondition> {
  QueryBuilder<Stage, Stage, QAfterFilterCondition> locationsElement(
      FilterQuery<StageLocation> q) {
    return QueryBuilder.apply(this, (query) {
...
extension StageQueryProperty on QueryBuilder<Stage, Stage, QQueryProperty> {
  ...
  QueryBuilder<Stage, List<StageLocation>, QQueryOperations>
      locationsProperty() {
    return QueryBuilder.apply(this, (query) {
...
const StageLocationSchema = Schema(
  name: r'StageLocation',
  id: 5744298917922589474,
  properties: {
    r'complete': PropertySchema(
      id: 0,
      name: r'complete',
  ...
  estimateSize: _stageLocationEstimateSize,
  serialize: _stageLocationSerialize,
  deserialize: _stageLocationDeserialize,
  deserializeProp: _stageLocationDeserializeProp,
);

int _stageLocationEstimateSize(
...
StageLocation _stageLocationDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = StageLocation(
...
P _stageLocationDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension StageLocationQueryFilter
    on QueryBuilder<StageLocation, StageLocation, QFilterCondition> {
  QueryBuilder<StageLocation, StageLocation, QAfterFilterCondition>
...
extension StageLocationQueryObject
    on QueryBuilder<StageLocation, StageLocation, QFilterCondition> {}
